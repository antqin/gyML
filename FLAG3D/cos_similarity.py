...
pushup_train_data_1 = load_data_from_filename('dataset/train/M001P001A006R001.pkl')
pushup_train_data_3 = load_data_from_filename('dataset/train/M001P001A006R003.pkl')

# X_train, y_train = load_data_from_filename('dataset/train')
# X_train = [x.flatten() for x in X_train]  # Flatten the 'poses' arrays for each training example
print(pushup_train_data_1)
# pushup_train_1 = [x.flatten() for x in pushup_train_data_1]
# pushup_train_3 = [x.flatten() for x in pushup_train_data_3]
...
# print(len(pushup_train_1[0]))

# # print(len(X_dev[0]))
# # print(len(X_test[0]))

# train_dimension = get_max_len(pushup_train_1, pushup_train_3)
...
# pushup_train_1_padded = pad_arrays(pushup_train_1, train_dimension)
# pushup_train_3_padded = pad_arrays(pushup_train_3, train_dimension)
# # X_dev = pad_arrays(X_dev, max_len)
# # X_test = pad_arrays(X_test, max_len)

# print(len(pushup_train_1_padded[0]))
# print(len(pushup_train_3_padded[0]))

# # Load the trained model
# # clf = load('logreg_model_100.pkl')

# print(pushup_train_1_padded)
